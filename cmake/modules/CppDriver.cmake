...
macro(CassUseLibuv)
  ...
  if(NOT "LIBUV_LIB-NOTFOUND" STREQUAL "${LIBUV_LIB}")
    if(NOT "LIBUV_LIB_DBG-NOTFOUND" STREQUAL "${LIBUV_LIB_DBG}")
  ...
  elseif(NOT "LIBUV_LIB_DBG-NOTFOUND" STREQUAL "${LIBUV_LIB_DBG}")
...
macro(CassUseZlib)
  ...
  if(DEFINED ZLIB_ROOT_DIR)
    ...
    set(CASS_INCLUDES ${CASS_INCLUDES} "${ZLIB_ROOT_DIR}/include")
    if(WIN32 AND CASS_USE_STATIC_LIBS)
      set(CASS_LIBS ${CASS_LIBS} debug "${ZLIB_ROOT_DIR}/lib/zlibd.lib" optimized "${ZLIB_ROOT_DIR}/lib/zlib.lib")
    else()
      set(CASS_LIBS ${CASS_LIBS} debug "${ZLIB_ROOT_DIR}/lib/zlibstaticd.lib" optimized "${ZLIB_ROOT_DIR}/lib/zlibstatic.lib")
    endif()
  else()
...
macro(CassSetCompilerFlags)
  ...
  if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    ...
    set(WINDOWS_LINKER_FLAGS "/INCREMENTAL:NO /LTCG")
    if(CASS_USE_STATIC_LIBS)
